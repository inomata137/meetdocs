...
export function CalendarSelectButton({ setTab }: SettingsSwitchProps) {
  return (
    <button
      type="button"
    ...
    >
      {/* https://www.veryicon.com/icons/miscellaneous/face-monochrome-icon/calendar-249.html title is added afterwards */}
      <svg
